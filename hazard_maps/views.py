...
def get_nearby_facilities(request):
    ...
    # ✅ CATEGORIZATION - Combine government buildings AND schools as evacuation centers
        ...
        # Find nearest evacuation center (prefer government buildings, fallback to schools)
        nearest_evacuation = None
        if evacuation_centers:
            nearest_evacuation = evacuation_centers[0]  # Government building
        elif schools:
            nearest_evacuation = schools[0]  # Fallback to nearest school
...
def calculate_suitability_score(lat, lng, hazard_data, nearby_facilities):
    ...
    total_evac_sites = evac_count + school_count  # Add this line
